...
for g in genres:
    print g, data.score[data[g]==True].std()
 
#What about average ratings by Genre? Film Noir still pretty high 
for g in genres:    
...
data.head(10) #But the scaled top ten is much different than the rank by average (from exercise above)
...
#Is there a rating bias toward newer movies?  
